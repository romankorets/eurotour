                                            ...
                                            <div class="row justify-content-start">
                                                <div class="col-md-4">
                                                    <label class="checkbox-transform">
                                                        <input type="checkbox" class="checkbox__input" name="places[]" value="{{ $place->id }}">
                                                        <span class="checkbox__label">Додати до туру</span>
                                                    </label>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="checkbox-transform">
                                                        <input type="radio" class="checkbox__input" name="startPlace" value="{{ $place->id }}">
                                                        <span class="checkbox__label">Початкова локація</span>
                                                    </label>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="checkbox-transform">
                                                        <input type="radio" class="checkbox__input" name="finishPlace" value="{{ $place->id }}">
